...
export function TypingArea({ text, onUpdate, isActive, onFinish }: TypingAreaProps) {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto">
      <div className="relative z-10 font-mono text-xl md:text-2xl leading-relaxed tracking-wide bg-slate-900/40 p-8 rounded-2xl border border-slate-700 min-h-[200px] select-none">
