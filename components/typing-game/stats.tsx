...
export function Stats({ wpm, accuracy, time, isPractice }: StatsProps) {
  if (isPractice) {
    return (
      <div className="w-full max-w-4xl flex justify-center">
        <div className="bg-slate-800/40 p-6 rounded-2xl border-2 border-emerald-500/30 flex flex-col items-center min-w-[280px] shadow-lg shadow-emerald-500/5 transition-all animate-in fade-in zoom-in duration-500">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-6xl font-black text-emerald-400 font-mono">{Math.round(accuracy)}</span>
    ...
    <div className="grid grid-cols-3 gap-4 w-full max-w-4xl">
      <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700 flex flex-col items-center">
        ...
        <div className="flex items-baseline gap-1 mt-1">
          <span className="text-3xl font-black text-sky-400 font-mono">{Math.round(wpm)}</span>
      ...
      <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700 flex flex-col items-center">
        ...
        <div className="flex items-baseline gap-1 mt-1">
          <span className="text-3xl font-black text-emerald-400 font-mono">{Math.round(accuracy)}</span>
      ...
      <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700 flex flex-col items-center">
        ...
        <div className="flex items-baseline gap-1 mt-1">
          <span className="text-3xl font-black text-amber-400 font-mono">{time}</span>
